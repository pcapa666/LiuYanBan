  ...
  list: [
    {
      ...
      iconPath: "static/iconfont/首页.png",
      selectedIconPath: "static/iconfont/首页 (1).png",
      text: "主页"
    },
    {
      pagePath: "pages/my/my",
      iconPath: "static/iconfont/我的.png",
      selectedIconPath: "static/iconfont/我的 (1).png",
      text: "我的"
    }
  ]
};
...
const b = true, k = "mp-weixin", T = S([]), P = k, A = S('{\n    "address": [\n        "127.0.0.1",\n        "192.168.3.54"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/HBuilderX.3.5.3.20220729/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), E = S('[{"provider":"aliyun","spaceName":"show","spaceId":"mp-6b453bb6-5a95-42a0-8f6a-8dde30785b9e","clientSecret":"Zzn3ZB+GeuobMvwbHFs6Xg==","endpoint":"https://api.next.bspapp.com"}]') || [];
let x = "";
try {
  x = "__UNI__7D1401F";
} catch (e2) {
